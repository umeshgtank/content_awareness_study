...
if __name__ == '__main__':
    ...
    score = bleu_score_sentence("The results appear in the January issue of Cancer, the American Cancer Society journal, being published online today.",
                                ["  The results appear today in the January issue of Cancer, the American Cancer Society journal.",
                                 "   The results appear in the January issue of Cancer, the American Cancer Society journal.",
                                 "    The findings appear in the January issue of Cancer, the American Cancer Society journal."])
    print("Computed bleu score is - ", score)
